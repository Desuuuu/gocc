...
\section{Getting started}
	\begin{enumerate}
		...
		\item Install \gocc:
			\begin{enumerate}
				\item In your command line run: \Code{go get github.com/Desuuuu/gocc/} (go get will git clone gocc into GOPATH/src/github.com/Desuuuu/gocc and run go install)

					or

				\item Alternatively clone the repository: \url{https://github.com/Desuuuu/gocc/archive/master.zip}. Followed by:
				\verb|go install github.com/Desuuuu/gocc|.
			\end{enumerate}

	\end{enumerate}

	Test your installation by running \verb|make test| from \verb|$GOPATH/src/github.com/Desuuuu/gocc|.
...
\section{First example}\label{sec:first example}
	...
	\verb|$GOPATH/src/github.com/Desuuuu/gocc/example/calc|
	...
	\subsection{The example grammar}
		...
		It declares the imported package \verb|github.com/Desuuuu/gocc/example/calc/token| (generated by gocc), which will be used in the action expressions of some productions of the grammar.
	...
	\subsection{Step 2: running \Code{go test}}
		...
		\begin{verbatim}
			...
			warning: building out-of-date packages:
			    github.com/Desuuuu/gocc/example/calc/token
			    github.com/Desuuuu/gocc/example/calc/lexer
			    github.com/Desuuuu/gocc/example/calc/errors
			    github.com/Desuuuu/gocc/example/calc/parser
			...
			PASS
			ok      github.com/Desuuuu/gocc/example/calc	0.017s
		\end{verbatim}
...
\section{Commandline syntax}\label{sec:commandline}
	\begin{verbatim}
        ...
        Flags:
          ...
          -o="/Users/marius/goprj/src/github.com/Desuuuu/gocc": output dir.
          -p="github.com/Desuuuu/gocc": package
...
\section{Example: parsing simple mail addresses} \label{sec:example mail}
	...
	\verb|$GOPATH/src/github.com/Desuuuu/gocc/example/mail|
...
\section{Example: reduce/reduce conflict handling} \label{sec:example rr}
	...
	\verb|$GOPATH/src/github.com/Desuuuu/gocc/example/rr|
	...
	When we run \gocc on \verb|$GOPATH/src/github.com/Desuuuu/gocc/example/rr/rr.bnf| we discover a reduce/reduce conflict:
...
-h             = false
-no_lexer      = false
-o             = /home/src/github.com/Desuuuu/gocc/example/rr
-p             = github.com/Desuuuu/gocc/example/rr
-u             = false
-v             = true
...
\section{Example: Shift/reduce conflict handling} \label{sec:example sr}
	...
	\verb|$GOPATH/src/github.com/Desuuuu/gocc/example/sr|
	...
	When we run \gocc on \verb|$GOPATH/src/github.com/Desuuuu/gocc/example/sr/sr.bnf| we discover a shift/reduce conflict:
...
\section{Example: Using an AST} \label{sec:example ast}
	...
	\verb|$GOPATH/src/github.com/Desuuuu/gocc/example/astx|

	The grammar is in \verb|ast.bnf|:

	\begin{verbatim}
		<<
		import "github.com/Desuuuu/gocc/example/astx/ast"
		import "github.com/Desuuuu/gocc/example/astx/token"
		>>
	...
	\verb|github.com/Desuuuu/gocc/example/astx/ast|.
	...
	\verb|$GOPATH/src/github.com/Desuuuu/gocc/example/astx/ast.go|:
	...
	\begin{verbatim}
		...
		--- PASS: TestFail (0.00s)
		PASS
		ok      github.com/Desuuuu/gocc/example/astx   0.006s	\end{verbatim}
...
\section{Example: Parser error recovery} \label{sec:error recovery}
	...
	\verb|$GOPATH/src/github.com/Desuuuu/gocc/examples/errorrecovery/er.bnf|:
	...
	\verb|$GOPATH/src/github.com/Desuuuu/gocc/examples/errorrecovery/|,
	...
	\begin{verbatim}
		...
		PASS		ok      github.com/Desuuuu/gocc/example/errorrecovery	0.015s
	\end{verbatim}

	The test case can be found in \\
	\verb|$GOPATH/src/github.com/Desuuuu/gocc/examples/errorrecovery/er_test.go|. \\
	...
	See \verb|$GOPATH/src/github.com/Desuuuu/gocc/examples/errorrecovery/errors/error.go| for the definition of errors.Error.
...
\section{Example: Using another lexer} \label{sec:no lexer}
	...
	\verb|$GOPATH/src/github.com/Desuuuu/gocc/examples/nolexer/nolexer.bnf|:
...
Saying : "hello"    << func () (Attrib, error) {
    ...
    \verb|$GOPATH/src/github.com/Desuuuu/gocc/examples/nolexer/gen.sh|:
...
litconv.go	rune.go
    ...
    \verb|$GOPATH/src/github.com/Desuuuu/gocc/examples/nolexer/scanner/scanner.go|
    ...
    \verb|$GOPATH/src/github.com/Desuuuu/gocc/examples/nolexer/parser/parser.go|.
    ...
    \verb|$GOPATH/src/github.com/Desuuuu/gocc/examples/nolexer/token/token.go|:
    ...
    \verb|$GOPATH/src/github.com/Desuuuu/gocc/examples/nolexer/scanner/scanner.go| implements a lexical analyser for this grammar as follows:
    ...
    \verb|$GOPATH/src/github.com/Desuuuu/gocc/examples/nolexer/nolexer_test.go|
